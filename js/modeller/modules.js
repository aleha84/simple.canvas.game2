...
SCG2.modeller.modules = {
	init: function(){
		...
		this.module_internal_triangle_bottomLeft = {
			...
			connectionOuterLinks: { above: false, below: true, left: true, right: false, center: false },
			connectionOuterLinksBase : { above: new Vector2(0,-15), below: new Vector2, left: new Vector2, right: new Vector2(15,0), center: new Vector2 },
		...
		this.module_internal_triangle_bottomRight = {
			...
			connectionOuterLinks: { above: false, below: true, left: false, right: true, center: false },
			connectionOuterLinksBase : { above: new Vector2(0,-15), below: new Vector2, left: new Vector2(-15,0), right: new Vector2, center: new Vector2 },
		...
		this.module_internal_triangle_topLeft = {
			...
			connectionOuterLinks: { above: true, below: false, left: true, right: false, center: false  },
			connectionOuterLinksBase : { above: new Vector2, below: new Vector2(0,15), left: new Vector2, right: new Vector2(15,0), center: new Vector2  },
		...
		this.module_internal_triangle_topRight = {
			...
			connectionOuterLinks: { above: true, below: false, left: false, right: true, center: false },
			connectionOuterLinksBase : { above: new Vector2, below: new Vector2(0,15), left: new Vector2(-15,0), right: new Vector2, center: new Vector2  },
